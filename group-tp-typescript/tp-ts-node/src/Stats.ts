...
if(myStatComputer instanceof StatComputer){
    console.log("myStatComputer est de type StatComputer")
}
/*
//NB : test  suivant impossible
if(myStatComputer instanceof WithStats){
    console.log("myStatComputer est de type WithStats")
}
car interface typescript dans code source seulement, plus au runtime
*/
